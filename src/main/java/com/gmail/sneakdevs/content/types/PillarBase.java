...
public class PillarBase extends PillarBlock {
    ...
    public PillarBase(String name, float hardness, float resistance, Material material, BlockSoundGroup sound, ItemGroup itemgroup, Tag<Item> tag, int miningLevel) {
