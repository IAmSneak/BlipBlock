...
public class RandomWordBlocks {
    ...
    public static final BlockBase WAZZASOFT_BLOCK = new BlockBase("wazzasoft_block", 0.8f, 0.8f, Material.STONE, BlockSoundGroup.WOOL, ItemGroup.BUILDING_BLOCKS, FabricToolTags.SHEARS, 0);
    ...
    public static final LightBlockBase BOACONIC_BLOCK = new LightBlockBase("boaconic_block", 4.0f, 8.0f, Material.STONE, BlockSoundGroup.WOOL, ItemGroup.BUILDING_BLOCKS, FabricToolTags.PICKAXES, 3, 6);
